  ...
  return (
    <section className="animated-hero-bg relative overflow-hidden bg-[#050914] py-16 md:py-20">
      <div className="relative mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        <ElectricBorder color="#a78bfa" speed={0.65} chaos={0.08} borderRadius={28} className="block" style={{ borderRadius: 28 }}>
          <div className="rounded-[28px] border border-violet-300/10 bg-[#070d1e]/78 p-5 backdrop-blur md:p-8">
